...
public class DateTimeDemo {
    ...
    private static void testDateTimeAPI() {
        ...
        System.out.println(localDateTime.get(ChronoField.HOUR_OF_DAY) + " : " + localDateTime.get(ChronoField.MINUTE_OF_HOUR) + " : " + (localDateTime.get(ChronoField.AMPM_OF_DAY)== 0 ? "AM" : "PM"));
