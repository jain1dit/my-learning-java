...
//    int[][] returnRouteList = {{1, 3000}};
    ...
    @Test
    public void primeAirRouteTest() {
        PrimeAirRoute.primeAirRoute(maxTravelDist, forwardRouteList, returnRouteList);
    }
}
